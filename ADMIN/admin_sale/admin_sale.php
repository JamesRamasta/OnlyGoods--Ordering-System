...
$link = new \PDO(   'mysql:host=127.0.0.1:3306;dbname=u712713341_cArXN;charset=utf8mb4', //'mysql:host=localhost;dbname=canvasjs_db;charset=utf8mb4',
                    'u712713341_M06nY', //'root',
                    'OnlyGoods.MNL2022', //'',
                    array(
...
$profit = $profit_income - $profit_expenses;
	...
	if(isset($_POST['generate-report'])){
		...
		//Monthly Revenue
		$content2 .='
			<h4 align="center">Monthly Revenue</h4><br/>
			<table border = "1" cellspacing = "0" cellpadding = "3" align="center">
				<tr>
					<th><b>Month</b></th>
			       	<th><b>Year</b></th>
