...
<html>
	<head>
	  ...
	  <link rel = "stylesheet" href = "admin_accountSettings.css">
	</head>
	...
	<body>
		...
		<div class="center">
			<h6>
			<marquee scrollamount="9"><h1>Account Information </h1></marquee>
			</h6>
			<label>Admin ID: </label>
			<span><?php echo $_SESSION['admin_ID']; ?></span><br>
			<label>Username: </label>
			<span><?php echo $_SESSION['admin_name']; ?></span><br>
			<label>Email: </label>
			<span><?php echo $_SESSION['admin_email']; ?></span><br>
			<label>Access Level: </label>
			<span><?php echo $_SESSION['admin_access']; ?></span><br>
			<center><br>
			<button onclick="location.href='admin_updateAccountSettings.php?admin_ID=<?= $_SESSION['admin_ID']; ?>'">Update</button>
			</div>
			</center>
